...
CREATE INDEX ix_articles_summary ON articles (summary);
...
CREATE INDEX ix_jt_feed_article_feed_id ON jt_feed_article (feed_id);
CREATE INDEX ix_jt_feed_article_article_id ON jt_feed_article (article_id);
